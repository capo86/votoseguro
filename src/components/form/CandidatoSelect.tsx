...
function CandidatoSelect({
  candidatos,
  emptyLabel = "Sin candidatos cargados",
  error,
  id,
  isLoading = false,
  label,
  register,
}: CandidatoSelectProps) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        >
          <option value="">
            {isLoading ? "Cargando candidatos" : hasCandidatos ? "Seleccionar candidato" : emptyLabel}
          </option>
